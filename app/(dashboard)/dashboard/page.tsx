    ...
    <>
      ...
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-white px-5 py-4 shadow-sm">
        <div>
          ...
          <p className="text-xs text-slate-400">Open customer pages</p>
        </div>
        <div className="flex flex-wrap items-center gap-2">
          <Link
            href="/"
            className="rounded-full border border-emerald-200 bg-emerald-50 px-4 py-2 text-xs font-semibold text-emerald-700 shadow-[0_8px_16px_rgba(16,185,129,0.15)]"
          >
            Landing Page
          </Link>
          <Link
            href="/menu"
            className="rounded-full bg-emerald-500 px-4 py-2 text-xs font-semibold text-white shadow-[0_10px_18px_rgba(16,185,129,0.25)]"
          >
            Open Menu
          </Link>
        </div>
