...
export default function MenuItemPage() {
  ...
  const handleAddToCart = () => {
    ...
    pushMenuNotification({
      type: "CART",
      title: { ar: "تمت إضافة المنتج للسلة", en: "Added to cart" },
      body: {
        ar: `${getLocalizedText(item.name, "ar")} × ${quantity} — ${formatCurrency(
          totalPrice,
          "ar"
        )}`,
        en: `${getLocalizedText(item.name, "en")} x ${quantity} — ${formatCurrency(
          totalPrice,
          "en"
        )}`,
      },
